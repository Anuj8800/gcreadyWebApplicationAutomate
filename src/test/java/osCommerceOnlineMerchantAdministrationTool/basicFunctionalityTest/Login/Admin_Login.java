package osCommerceOnlineMerchantAdministrationTool.basicFunctionalityTest.Login;
...
public class Admin_Login {
	...
	driver.findElement(By.name("password")).sendKeys("Temp@2020");        //Temp@2020
	...
	driver.findElement(By.name("password")).sendKeys("Temp@0000");        //Temp@2020
	driver.findElement(By.id("tdb1")).click();
